...
includes:
  ...
  - name: "On-Page SEO"
    detail: "Optimised headings, structure, internal links, and metadata that help search engines understand and rank your content."
  - name: "SEO Copywriting"
    detail: "Content that reads naturally for humans while hitting every technical mark for search engines."
  - name: "Meta Copy"
    detail: "Compelling title tags and meta descriptions that boost click-through rates from search results."
  - name: "Internal Linking Strategy"
    detail: "A structured linking framework that distributes authority and keeps users moving deeper into your site."
order: 2
---
